...
$config = array(
	...
	*/
	...
	// Đường dẫn cơ sở dùng để nhập URL đầy đủ cho mỗi trang. Biến url tương đối thành tuyệt đối.
	//Tất cả phải bắt đầu bằng http://localhost/yiidemo
	...
	*/
	...
	/*
	|--------------------------------------------------------------------------
	| relative path(đường dẫn tương đối ) from filemanager folder to upload folder
	|--------------------------------------------------------------------------
	|
	| with final /
	|
...
//Trả về http://localhost và nối thêm /yiidemo
